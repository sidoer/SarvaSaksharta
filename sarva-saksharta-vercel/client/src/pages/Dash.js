...
const Dash = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.post('https://sasa-back-vercel.vercel.app/api/grade-check', { user }, {
          headers: {
  ...
  useEffect(() => {
    const fetchForum = async () => {
      try {
        const response = await axios.post('https://sasa-back-vercel.vercel.app/api/get-forum', { user }, {
          headers: {
            Authorization: localStorage.getItem('token'),
          },
        });
  ...
  useEffect(() => {
    const fetchTasks = async () => {
      try {
        const response = await axios.post('https://sasa-back-vercel.vercel.app/api/get-tasks', { user }, {
          headers: {
            Authorization: localStorage.getItem('token'),
          },
        });
  ...
  const messageData = async (e) => {
    ...
    try {
      const response = await axios.post('https://sasa-back-vercel.vercel.app/api/forum', messageRetrieve, {
        headers: {
          Authorization: localStorage.getItem('token'),
        },
      });
