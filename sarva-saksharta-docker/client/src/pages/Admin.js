...
const Admin = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.post('http://localhost:5500/api/role-check', { user }, {
          headers: {
            Authorization: localStorage.getItem('token'),
          },
        });
  ...
  const deleteAccount = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:5500/api/delete', account, {
        headers: {
          Authorization: localStorage.getItem('token'),
        },
      });
  ...
  const sendApproval=async(item)=>{
    ...
    try {
      const response = await axios.post('http://localhost:5500/api/approve-content',{filename:item.filename},{
        headers: {
          Authorization: localStorage.getItem('token'),
        },
      });
  ...
  const sendDelete=async(item)=>{
    console.log(item.filename)
    try {
      const response = await axios.post('http://localhost:5500/api/delete-content',{filename:item.filename},{
        headers: {
          Authorization: localStorage.getItem('token'),
        },
      });
  ...
  const addTeacher = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:5500/api/addteacher', account, {
        headers: {
          Authorization: localStorage.getItem('token'),
        },
      });
  ...
  const addAdmin = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:5500/api/addadmin', account, {
        headers: {
          Authorization: localStorage.getItem('token'),
        },
      });
