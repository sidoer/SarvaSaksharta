...
const Home = () => {
  ...
  useEffect(() => {
    const fetchCaptcha = async () => {
      try {
        const response = await axios.get('http://localhost:5500/api/captcha', {
  ...
  const signup_data = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:5500/api/signup', signup_retrieve);
  ...
  const signin_data = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:5500/api/signin', signin_retrieve);
